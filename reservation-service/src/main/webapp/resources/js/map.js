$(function(){
	...
	naver.maps.Service.geocode({address: myaddress}, function(status, response) {
		...
		var mapurl = "https://openapi.naver.com/v1/map/staticmap.bin?clientId=7HYSSZyvxLo0lyAcabtI&url=http://localhost:8080/&crs=EPSG:4326&center="+point+"&level=12&w=300&h=300&baselayer=default&markers="+point;
