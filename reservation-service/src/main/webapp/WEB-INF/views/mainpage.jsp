    ...
    <div id="container">
        ...
        <div class="event">
            ...
            <div class="section_event_lst">
                <p class="event_lst_txt">바로 예매 가능한 전시, 공연, 행사가 <span class="pink">${product.cnt }개</span> 있습니다 </p>
                <div class="wrap_event_box">
                    <!-- [D] lst_event_box 가 2컬럼으로 좌우로 나뉨, 더보기를 클릭할때마다 좌우 ul에 li가 추가됨 -->
                    <ul class="lst_event_box">
                    <c:forEach var="pi" items="${product.list }" step="2" begin="0" end="5">
                    	<li class="item" data-category="${product.id }">
                    		<a href="#" class="item_book">
                    			<div class="item_preview"> <img alt="${pi.fileName }" class="img_thumb" src="${pi.saveFileName }"><span class="img_border"></span> </div>
                                <div class="event_txt">
                                    <h4 class="event_txt_tit"> <span>${pi.productName }</span> <small class="sm">${pi.placeName }</small> </h4>
                                    <p class="event_txt_dsc">${pi.description }</p>
                                </div>
                    		</a>
                    	</li>
                    </c:forEach>
                    ...
                    <ul class="lst_event_box">
                    <c:forEach var="pi" items="${product.list }" step="2" begin="1" end="5">
                    	<li class="item" data-category="${product.id }">
                    		<a href="#" class="item_book">
                    			<div class="item_preview"> <img alt="${pi.fileName }" class="img_thumb" src="${pi.saveFileName }"><span class="img_border"></span> </div>
                                <div class="event_txt">
