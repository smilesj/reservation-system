            ...
            <div class="ct_wrap">
                ...
                <div class="group_visual">
                    <div class="container_visual" style="width: 414px;">
                        <ul class="visual_img">
                            <li class="item" style="width: 414px;"> <img alt="" class="img_thumb" src="/api/files/${product.productId }"> <span class="img_bg"></span>
                                <div class="preview_txt">
                                    <h2 class="preview_txt_tit">${product.productName }</h2> <em class="preview_txt_dsc">₩12,000 ~ </em><em class="preview_txt_dsc"><fmt:formatDate value="${product.displayInfo.displayStart }" pattern="yyyy.MM.dd.(E)"/>~<fmt:formatDate value="${product.displayInfo.displayEnd }" pattern="yyyy.MM.dd.(E)"/>, 잔여티켓 2769매</em> </div>
                            </li>
                        </ul>
                    </div>
                </div>
                <div class="section_store_details">
                    <div class="store_details">
                        <h3 class="in_tit">${product.productName }</h3>
                        <p class="dsc">
                            	장소 : ${product.displayInfo.placeStreet }(${product.displayInfo.placeLot }) <br>
                            	기간 : <fmt:formatDate value="${product.displayInfo.displayStart }" pattern="yyyy.MM.dd.(E)"/>
                    	...
                    	<div class="qty">
                            ...
                            <div class="qty_info_icon"> 
                            	<strong class="product_amount">
                            		<c:if test="${ticket.priceType == 1 }"><span>성인</span></c:if>
                            		<c:if test="${ticket.priceType == 2 }"><span>청소년</span></c:if>
                            		<c:if test="${ticket.priceType == 3 }"><span>어린이</span></c:if>
                            	</strong> 
                            ...
                            <form class="form_horizontal">
                                ...
                                <div class="inline_form last"> <label class="label" for="message">예매내용</label>
                                    <div class="inline_control">
                                        <p class="inline_txt selected">2017.2.17.(금)~2017.4.18.(화), 총 <span>0</span>매</p>
                                    </div>
                                </div>
                            </form>
                        </div>
